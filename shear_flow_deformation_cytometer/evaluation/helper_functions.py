...
def apply_velocity_fit(data2, start_params=[3.8, 0.64, 0.04], method="TNC"):
    config = {"channel_length_m": 5.8e-2, "channel_width_m": 186e-6}
    p0, vel, vel_grad = fit_velocity_pressures(data2, config, x_sample=100, start_params=start_params, method=method)
    eta0, delta, tau = p0
