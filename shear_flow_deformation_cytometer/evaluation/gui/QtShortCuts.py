...
class QInput(QtWidgets.QWidget):
    ...
    def __init__(self, name=None, tooltip=None, stretch=False, value_changed=None, settings=None, settings_key=None):
...
class QInputNumber(QInput):
    ...
    def __init__(self, name=None, value=0, min=None, max=None, use_slider=False, float=True, decimals=2,
...
class QInputString(QInput):
    ...
    def __init__(self, name=None, value="", allow_none=True, type=str, unit=None, name_post=None, validator=None, **kwargs):
        # initialize the super widget
        QInput.__init__(self, name, **kwargs)
...
class QInputBool(QInput):
    ...
    def __init__(self, name=None, value=False, **kwargs):
        # initialize the super widget
        QInput.__init__(self, name, **kwargs)
...
class QInputChoice(QInput):
    ...
    def __init__(self, name=None, value=None, values=None, value_names=None, reference_by_index=False, **kwargs):
        # initialize the super widget
        QInput.__init__(self, name, **kwargs)
...
class QInputFolder(QInput):
    ...
    def __init__(self, name=None, value=None, dialog_title="Choose Folder", filename_checker=None, allow_edit=False, **kwargs):
        # initialize the super widget
        QInput.__init__(self, name, **kwargs)
